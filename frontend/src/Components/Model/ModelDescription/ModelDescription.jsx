...
function ModelDescription({ selectedPart }) {
        ...
        try {
          await axios.post("http://localhost:3001/preload", {
            data: {
              ...
              details:
                partInfo.manufacturing || "No manufacturing info available.",
    ...
    try {
      ...
      if (typeof botReply === "string") {
        ...
        setChat((prev) => [
          ...
          {
            sender: "bot",
            text: `**Detailed Explanation:** ${botReply.detailedExplanation}`,
          },
  ...
  if (!selectedPart) {
    return (
      <div className="description">
        ...
        <p>
          Select a bicycle part from the drawer to learn about its manufacturing
  ...
  return (
    <div className="description">
      ...
      <h3>Usage:</h3>
      <p>
        This {partInfo.name?.toLowerCase() || "part"} is a key component of the
        bicycle, contributing to its overall functionality and performance.
      </p>
      <h3>Educational Note:</h3>
      <p>
        Understanding how this part is manufactured helps students appreciate
        the engineering and materials science behind everyday objects like
        bicycles.
      </p>
      <button className="chat-button" onClick={toggleChat}>
        💬
